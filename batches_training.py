...
class PlayerSQN:
    def __init__(self):
        ...
        self.model=load_model("2022A7PS0569G_MODEL_one.keras")
...
def main(smartMovePlayer1_test):
    """
    Simulates multiple TicTacToe games and trains the SQN player after each smartness level increment.
    """
    playerSQN = PlayerSQN()
    ...
    playerSQN.model.save("tictactoe_trained_model_v2.h5")
    print("Model saved as 'tictactoe_trained_model.h5'.")
